...
INSERT INTO `citta` (`idviaggio`, `nome`, `stato`, `datainizio`, `datafine`, `tipoalloggio`, `costoalloggio`, `voto`, `feedback`) VALUES
(1, 'parigi', 'francia', '2013-08-08', '2013-08-08', 'b&b', 4, 6, 1),
(1, 'roma', 'italia', '2003-08-08', '2013-08-09', 'hotel', 1, 9, 7),
(2, 'borgo', 'italia', '2003-08-08', '2013-08-10', 'in strada', 5000, 1,2),
(7, 'Casa del diablo', 'EIRE', '2013-08-07', '2013-08-17', 'ponte', 300, 3, 2),
(7, 'Rieti', 'Italia', '2013-08-06', '2013-08-08', 'casa', 20, 2, 2),
(8, 'Roma', 'Italia', '2013-08-04', '2013-08-10', 'Casa', 500, 8, 2),
(9, 'Casa del diablo', 'EIRE', '2013-08-07', '2013-08-17', 'ponte', 300, 3, 2);
...
INSERT INTO `luogo` (`idviaggio`, `nome`, `nomecitta`, `sitoweb`, `percorso`, `costobiglietto`, `guida`, `coda`, `durata`, `commentolibero`, `feedback`) VALUES
(1, 'colosseo', 'roma', 'www.colosseo.it', 'metro+auto', 5, 'utile', 'alta', '03:00:00', 'kjwqkl fkjf', 2),
(1, 'torre eiffel', 'parigi', 'www.torreeiffel.it', 'metro', 2, 'non utile', 'minima', '02:00:00', 'uedfòk fwlfhl fwwelhwe', 3),
(2, 'casa brunetto', 'borgo', 'www.brunetto.it', 'metro+auto', 5, 'utile', 'alta', '23:40:00', 'hjgsdfklsdfh kfgdsg', 4),
(7, '5tdhdrh', 'fdbdrfh', 'fdshbsdrhbred', 'gsrdhbxdshb', 345, 'si', 'media', NULL, 'sdfbhewsgewsg', 5),
(7, 'casa', 'htredjhrh', 'tdrjhdhrdsh', NULL, 456, 'si', 'media', '03:00:00', 'rhsjhdrj', 6),
(8, 'Colosseo', 'Roma', 'www.colosseo.it', 'per strada', 3000, 'si', 'alta', '03:00:00', 'bellissimo', 7),
(9, 'U burgu', 'Rieti', 'www.èsemprefesta.burgu', 'tutti lo sanno', 0, 'si', 'minima', '00:00:02', 'bellissima', 4);
...
CREATE TABLE IF NOT EXISTS `utente` (
  ...
  `messaggi` varchar(1000) DEFAULT NULL,
...
INSERT INTO `utente` (`username`, `nome`, `cognome`, `residenza`, `nazione`, `mail`, `password`, `cod_attivazione`, `stato`, `avvertimenti`) VALUES
('Emanuela', 'eghsg', 'egagew', 'Rieti', 'eagas', 'agewg', 'emanuela', '2122454021', 'non_attivo',0),
('kekko', 'francesco', 'verzicco', 'casabianca', 'stato proprieta', 'kekko@libero.it', '1234', '1234', 'attivo',1),
('pippo', 'Pippo', 'Cognome', 'Rieti', 'EmanuelaLand', 'pippo@pippo.it', 'pippo', '1476023205', 'attivo',2),
('riccio', 'ric', 'verzicco', 'non pervenuta', 'rifugiato politico', 'riccio@libero.it', '1234', '1234', 'attivo',3),
('stef', 'ste', 'verzicco', 'los burgos', 'italia', 'kekko@libero.it', '1234', '1234', 'attivo',4),
('root', 'admin', 'admin', 'admin', 'admin', 'admin.egrweg@domain.it', 'administrator', '423940770', 'admin',0);
