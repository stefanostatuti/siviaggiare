<?php /* Smarty version 2.6.26, created on 2013-10-29 13:13:59
...
"/> </td>
                        <?php if ($this->_tpl_vars['messaggi']['user'] != false || $this->_tpl_vars['messaggi']['userdata'] != false): ?>
                            <td class="error">
                                <?php if ($this->_tpl_vars['messaggi']['user'] != 'false'): ?> <?php echo $this->_tpl_vars['messaggi']['user']; ?>
  <?php endif; ?>
