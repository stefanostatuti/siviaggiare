...
/*
$config['smarty']['template_dir'] =
    '/opt/lampp/htdocs/siviaggiare/siviaggiare/templates/main/template/';
//'/home/cicerone/public_html/webprog/bookstore/templates/main/template/';
$config['smarty']['compile_dir'] =
    '/opt/lampp/htdocs/siviaggiare/siviaggiare/templates/main/templates_c/';
$config['smarty']['config_dir'] =
    '/opt/lampp/htdocs/siviaggiare/siviaggiare/templates/main/configs/';
$config['smarty']['cache_dir'] =
    '/opt/lampp/htdocs/siviaggiare/siviaggiare/templates/main/cache/';
*/
